       ...
       */
        ...
        public function __construct( $parent ) {
            ...
            if ( empty( $this->_extension_dir ) ) {
              ...
              $this->_extension_dir = trailingslashit( str_replace( '\\', '/', get_template_directory() ) );
          ...
          foreach( $this->parent->sections as $key => $section ) {
            ...
            foreach( $section['fields'] as $skey => $option ) {
              ...
              if ($option['type'] != "heading" || !empty($option['type'])) {
                ...
                $wp_customize->add_setting( $option['id'], $customSetting, array('sanitize_callback' => '__return_false') );
