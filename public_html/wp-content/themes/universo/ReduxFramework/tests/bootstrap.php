...
if ( ! $_tests_dir ) {
	$_tests_dir = realpath( get_template_directory() . '/../tmp-wp-dev/wordpress-tests' ) . '/';
}
...
function _manually_load_plugin() {
	require get_template_directory() . '/tivwp-dm.php';
}
...
//require_once get_template_directory() . '/framework/class-wpseo-unit-test-case.php';
